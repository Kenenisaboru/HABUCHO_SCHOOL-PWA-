...
import { validateAnnouncement, validateUpdateAnnouncement } from "../middleware/validate.js";
...
router.put("/:id", authenticateUser, authorizeRoles("admin", "teacher"), validateUpdateAnnouncement, updateAnnouncement);
